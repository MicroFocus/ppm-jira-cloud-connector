...
public class JIRAConstants {
    ...
    public static final String JIRA_ACCOUNT_ID_PREFIX = "#@#accountId#@#";
    ...
    /**
     * @see com.ppm.integration.agilesdk.connector.jira.cloud.service.JIRAService#getIssueTypesPerProject()
     */
