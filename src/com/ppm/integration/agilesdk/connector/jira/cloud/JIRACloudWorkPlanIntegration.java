...
import com.ppm.integration.agilesdk.connector.jira.cloud.rest.util.exception.JIRAConnectivityExceptionHandler;
...
import com.ppm.integration.agilesdk.connector.jira.cloud.util.WorkDrivenPercentCompleteExternalTask;
...
public class JIRACloudWorkPlanIntegration extends WorkPlanIntegration {
    ...
    public List<Field> getMappingConfigurationFields(WorkPlanIntegrationContext context, ValueSet values) {
        ...
        final LocalizationProvider lp = Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class);
        ...
        // Making this a set will remove all duplicated issue type names, which WILL happen if you have team-managed projects.
            ...
            fields.add( new CheckBox(getParamNameFromIssueTypeName(issueType), issueType, isChecked) {
                ...
                fields.addAll(Arrays.asList(new Field[] {new LineBreaker(),
                        ...
                        new PlainText(JIRAConstants.OPTION_ROOT_TASK_NAME, "OPTION_ROOT_TASK_NAME",
                                Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_ROOT_TASK_TASK_NAME"), false) {
                            @Override public List<String> getStyleDependencies() {
            ...
            case JIRAConstants.GROUP_EPIC:
                ...
                if (includeIssuesWithNoGroup && !noEpicIssues.isEmpty()) {
                    rootTasks.add(WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                        ...
                        @Override public String getName() {
                            return Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_NO_EPIC_DEFINED_TASK_NAME");
                        }
            ...
            case JIRAConstants.GROUP_STATUS:
                ...
                if (includeIssuesWithNoGroup && !noStatusIssues.isEmpty()) {
                    rootTasks.add(WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                        ...
                        @Override public String getName() {
                            return Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_NO_STATUS_DEFINED_TASK_NAME");
                        }
            ...
            case JIRAConstants.GROUP_SPRINT:
                ...
                for (final String sprintId : issuesBySprintId.keySet()) {
                    ...
                    rootTasks.add(WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                        ...
                        @Override public String getName() {
                            return sprint == null ? Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_SPRINT_PREFIX_TASK_NAME") + " " + sprintId : sprint.getName();
                        }
                ...
                if (includeIssuesWithNoGroup && !backlogIssues.isEmpty()) {
                    rootTasks.add(WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                        ...
                        @Override public String getName() {
                            return Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_BACKLOG_TASK_NAME");
                        }
        ...
        if (!StringUtils.isBlank(values.get(JIRAConstants.OPTION_ADD_EPIC_MILESTONES))) {
            ...
            if (!selectedEpics.isEmpty()) {
                ...
                rootTasks.add(WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                    ...
                    @Override
                    public String getName() {
                        return Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("EPIC_MILESTONE_TASK_NAME");
                    }
                    ...
                    ExternalTask rootTask = WorkDrivenPercentCompleteExternalTask.forSummaryTask(new ExternalTask() {
                        ...
                        @Override public String getName() {
                            ...
                            if (StringUtils.isBlank(rootTaskName)) {
                                rootTaskName = Providers.getLocalizationProvider(JIRACloudIntegrationConnector.class).getConnectorText("WORKPLAN_ROOT_TASK_TASK_NAME");
                            }
